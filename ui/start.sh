...
# Everyday Productivity Accelerators - Development Starter
# Lightweight Strands Agents implementation

set -e

echo "🚀 Starting Everyday Productivity Accelerators with Strands Agents..."

# Set environment variables
export PYTHONPATH="${PYTHONPATH}:$(pwd)/ui/backend"
...
echo -e "${GREEN}Starting Strands Agents backend on port 8000...${NC}"
